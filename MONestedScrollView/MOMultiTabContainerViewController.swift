...
class MOMultiTabContainerViewController: UIViewController, MOSubScrollViewProtocol {
    ...
    override func viewDidLayoutSubviews() {
        ...
        self.segmentControl.frame = CGRect(x: safeInset.left,
                                           y: safeInset.top,
        ...
        self.scrollView.contentSize = CGSize(width: containerWidth * 2.0,
                                             height: contentHeight)
        
        self.tabViewCtl.view.frame = CGRect(x: 0.0,
                                            y: 0.0,
                                            width: containerWidth,
                                            height: contentHeight)
        self.webViewCtl.view.frame = CGRect(x: containerWidth,
                                            y: 0.0,
                                            width: containerWidth,
                                            height: contentHeight)
    }
